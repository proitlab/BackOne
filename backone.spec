...
if [ -x /usr/bin/checkmodule -a -x /usr/bin/semodule_package -a -x /usr/sbin/semodule ]; then
  rm -f /var/lib/backone/backone.mod
  /usr/bin/checkmodule -M -m -o /var/lib/backone/backone.mod /var/lib/backone/backone.te
  if [ -f /var/lib/backone/backone.pp ]; then
    rm -f /var/lib/backone/backone.pp
    /usr/bin/semodule_package -o /var/lib/backone/backone.pp -m /var/lib/backone/backone.mod
    /usr/sbin/semodule -u /var/lib/backone/backone.pp
  else
    /usr/bin/semodule_package -o /var/lib/backone/backone.pp -m /var/lib/backone/backone.mod
    /usr/sbin/semodule -i /var/lib/backone/backone.pp
  fi
fi
%endif
